    ...
    <div id="tiktok" className="py-[6%] scroll-mt-8">
      ...
      <div className="flex flex-col lg:flex-row gap-16 justify-center items-center w-full max-w-7xl mx-auto px-4">
        {tiktokVideos.map((video, index) => (
          ...
          >
            <div className="border border-border bg-background/40 backdrop-blur-sm rounded-xl overflow-hidden hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20 transition-all duration-300">
              {/* TikTok Video Embed */}
